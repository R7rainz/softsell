    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          type: "bot",
          content:
            "Oops! Something went wrong while connecting to our assistant. Please try again later or contact support.",
          suggestions: ["Ask another question", "Contact a human agent"],
        },
      ])
    }
  }
    ...
    if (suggestion === "Contact a human agent") {
      setMessages((prev) => [
        ...prev,
        {
          type: "bot",
          content:
            "Our team is available Monday-Friday, 9am-5pm IST. Please fill out the contact form above and a representative will get back to you within 24 hours.",
